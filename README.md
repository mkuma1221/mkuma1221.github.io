...
<h3 style="color: #000080; font-size: 1.4em; margin-top: 20px; margin-bottom: 15px; border-bottom: 1px solid #e0e0e0; padding-bottom: 8px; font-family: sans-serif;">
...
<table style="border: none; border-collapse: collapse; width: 100%;" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="45%" valign="top" align="center" style="border: none;">
      <img src="SAT.png" alt="Satellite Trajectory" style="width: 100%; max-width: 400px; height: auto; display: block; border-radius: 4px;">
